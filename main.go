...
//    import _ "github.com/DoOR-Team/gorm/dialects/mysql"
//    // import _ "github.com/DoOR-Team/gorm/dialects/postgres"
//    // import _ "github.com/DoOR-Team/gorm/dialects/sqlite"
//    // import _ "github.com/DoOR-Team/gorm/dialects/mssql"
...
func (s *DB) BatchCreate(value interface{}) *DB {
	scope := s.NewScope(value)
	return scope.callCallbacks(s.parent.callbacks.batchCreates).db
}
